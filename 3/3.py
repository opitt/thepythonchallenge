src = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
# pattern = "(?<![A-Z])[A-Z]{3}([a-z])[A-Z]{3}(?![A-Z])" # negative lookahead and negative lookbehind
m = re.findall(pattern, src)
print(m)

sol = "".join(m)
url_3 = "http://www.pythonchallenge.com/pc/def/equality.html"
url_4 = url_3.replace("equality", sol)
